...
function getOverallResult() {
  ...
  overallInfo += "<tr><th class=\"col-md-1\">Main ability</th><td class=\"col-md-4\">" + utg.app_main_ability + "</td></tr>\n";
  overallInfo += "<tr><th class=\"col-md-1\"># Total abilities</th><td class=\"col-md-4\">" + utg.app_num_total_abilities + "</td></tr>\n";
  ...
  overallInfo += "<tr><th class=\"col-md-1\">Device name</th><td class=\"col-md-4\">" + utg.device_name + "</td></tr>\n";
  overallInfo += "<tr><th class=\"col-md-1\">Model name</th><td class=\"col-md-4\">" + utg.device_model_number + "</td></tr>\n";
