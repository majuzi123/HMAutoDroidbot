...
setup(
    ...
    install_requires=['androguard==3.4.0a1', 'networkx', 'Pillow', 'coloredlogs', 'pyyaml', 'requests', 'pyvis', 'treelib', 'torch', 'InstructorEmbedding', 'sentence_transformers', 'pytesseract', 'openai'],
)
